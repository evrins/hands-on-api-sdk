...
class SWCConfig:
    ...
    def __init__(self, base_url: str = None, backoff: bool = True, backoff_max_time: int = 30, bulk_file_format: str = 'csv'):
        ...
        self.swc_base_url = base_url or os.getenv('SWC_API_BASE_URL')
